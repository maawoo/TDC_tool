...
def process_sar(settings, debug):
    """SAR processing was not fully needed for the TDC, as processed Sentinel-1 data was provided.
    This part was therefore in a 'work in progress' state during the thesis. SOme postprocessing steps were, however,
    applied to the Sentinel-1 data on TerraSense. They are located in the script 'terrasense_crop_aoi.py' """
